...
<div class="book-body">
  <p>
    Decoupling CO2 emissions from economic growth remains one of the main challenges of the green transition, and Brazil allegedly managed to do it. One of the most successful cases of state-driven decarbonization occurred in Brazil from 2004 to 2012, when the country implemented policies that curbed deforestation in the Amazon by over 80%. On the growth side, and concurrently, a similar "success" story emerges on the Amazon frontier: a series of policies made Brazil the largest global producer and exporter of beef and soy. How?
  </p>
  <p>
